...
#import "SponsoredViewController.h"
#import <MBProgressHUD.h>
#import <Google/Analytics.h>
#import "NotificationManager.h"
@interface SponsoredViewController ()
@property (strong, nonatomic) WKWebView* webView;
@property (strong, nonnull) MBProgressHUD *hud;
@end

@implementation SponsoredViewController
...
- (void)viewDidLoad {
    ...
    NSURLRequest* urlRequest = [NSURLRequest requestWithURL:[NSURL URLWithString:@"http://sitcon.org/2017/#sponsor-page"]];
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    [tracker set:kGAIScreenName value:@"SponsoredView"];
